...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handlerAllExceptions(Exception ex, WebRequest request) {
        CustomizedExceptionResponse exceptionResponse = new CustomizedExceptionResponse(
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        CustomizedExceptionResponse customizedExceptionResponse = new CustomizedExceptionResponse(
