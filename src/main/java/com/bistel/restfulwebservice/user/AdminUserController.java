...
//    @GetMapping(value = "/users/{id}", headers="X-API-VERSION=1")
    @GetMapping(value = "/users/{id}", produces="application/vnd.bistel.appV1+json")
...
@GetMapping(value = "/users/{id}", produces="application/vnd.bistel.appV2+json")
public MappingJacksonValue retrieveUserV2(@PathVariable int id) {
        ...
        BeanUtils.copyProperties(user, userV2); //id, mane, joinDate, password, ssn
